  ...
  <!-- Search, buttons, table, etc. -->
    ...
    <div class="container border mt-4">
        <div class="my-3">
            ...
            <input type="text" class="form-control" id="searchField" placeholder="Please input names here to search!">
            <div class="d-flex mt-2">
            <div class="d-flex gap-2">
                <button type="button" class="btn btn-primary" id="searchButton">Search</button>
                <button type="button" class="btn btn-secondary" id="clearSearchButton">Clear</button>
            </div>
            <button type="button" class="btn btn-success ms-auto" id="addUserButton" data-bs-toggle="modal" data-bs-target="#addUserModal">Add User</button>
            </div>
        </div>

        <div class="row justify-content-center">
            <table class="table table-responsive table-dark table-striped-columns table-hover table-borderless">
                <tr>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form onsubmit="registerUser(event, 'all_users.php')" class="border p-3" id="addUserForm">
                        <div class="mb-3">
